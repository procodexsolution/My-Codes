            ...
            <AnimatePresence>
              {showButton && (
                ...
                >
                  <a
                    href="#projects"
                    className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2 bg-yellow-400 text-black font-semibold rounded shadow-lg hover:bg-yellow-300 transition text-xs sm:text-sm md:text-base w-full sm:w-auto text-center whitespace-nowrap overflow-hidden"
                  >
                    <Laptop size={16} />
                    <span className="truncate">See Projects</span>
                  </a>
